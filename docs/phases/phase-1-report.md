...
|---|---|---|
| Day 1 — Adapter Protocol + scaffolding + import-linter contract | done | [`src/maquette/adapters/__init__.py`](../../src/maquette/adapters/__init__.py) (`Adapter` Protocol, `AdapterRefusal`); [`src/maquette/adapters/build123d_target.py`](../../src/maquette/adapters/build123d_target.py) skeleton with dispatch + per-kind placeholders + `_: Adapter = emit` static-conformance assertion; new `[tool.importlinter]` contract (adapters depend only on `maquette.intent` + stdlib minus I/O); [`tests/test_adapters_protocol.py`](../../tests/test_adapters_protocol.py). Commit `1ccf361`. |
