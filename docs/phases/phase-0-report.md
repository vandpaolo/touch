...
| Day 2 — Domain model | done | [`src/maquette/intent.py`](../../src/touch_backend/intent.py), [`src/maquette/intent_validation.py`](../../src/touch_backend/intent_validation.py), [`tests/test_intent.py`](../../tests/test_intent.py) (14 tests), [`tests/test_intent_validation.py`](../../tests/test_intent_validation.py) (28 tests — positive + negative for each of the 11 kinds). Commit `edf6976`. |
| Day 3 — Pricing + config | done | [`src/maquette/pricing.py`](../../src/touch_backend/pricing.py) (`Tokens`, `ModelPrice`, three-model `_TABLE` from ADR 0003, `price()`), [`src/maquette/config.py`](../../src/touch_backend/config.py) (`Config` + `load()` with full precedence), [`tests/test_pricing.py`](../../tests/test_pricing.py) (11 tests), [`tests/test_config.py`](../../tests/test_config.py) (15 tests). Commit `5e7ee63`. |
