...
1. **Extras-only Intents produce no STEP export (highest-impact
   ...
   phase-1 surprise #3). But [`_export`](../../src/touch_backend/adapters/build123d_target.py)
